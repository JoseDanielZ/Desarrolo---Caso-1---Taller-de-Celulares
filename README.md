# TecniRápido – Sistema de Gestión de Taller de Reparación  
**Solución: Jose Daniel Zumarraga**

## Descripción General

TecniRápido es un sistema web desarrollado con **Laravel** para la gestión integral de reparaciones de equipos electrónicos en el taller TecniRápido.  
...
Repositorio GitHub:  
https://github.com/JoseDanielZ/Desarrolo---Caso-1---Taller-de-Celulares